...
void
showParams (ostream &out)
{
  out << "User settings:" << boolalpha << "\n delay,         " << delay
...
void
readInputBurst (istream &inFile, ostream &logStream)
{
...
void
readPilotData (istream &inFile, ostream &logStream)
{
...
void
showBurst (ostream &out)
{
  out << cycleCount << ',' << duration << ',' << nominalFreq << ','
      << actualFreq;
}
...
bool
readAIFFheader (istream &inFile, ostream &logStream)
{
...
bool
readWAVEheader (istream &inFile, ostream &logStream)
{
...
void
writeOutputData (ostream &outfile)
{
  int i = 0, j = 0;	// local loop indices
  short a = 0, b = 0;
  double y = 0.0;
...
void
writePilotTone (ostream &outfile)
{
...
void
writeAIFFfile (ostream &outFile, ostream &logFile)
{
...
void
writeWAVEfile (ostream &outFile, ostream &logFile)
{
